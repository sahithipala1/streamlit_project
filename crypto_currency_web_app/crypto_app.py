...
This app retrieves cryptocurrency prices for the top 100 cryptocurrency from the **Coin Market Cap**!
...
BeautifulSoup, requests, json, time 
* **Data source: ** ( [Coin Market Cap ](https://coinmarketcap.com)) 
...
## Divided page in to 3 columns (col1 = sidebar, col2 and col3 = page contents)
...
# Web scraping of Coin Market Cap data
@st.cache
def load_data():
